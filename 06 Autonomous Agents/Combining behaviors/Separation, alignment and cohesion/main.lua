...
VELOCITY_MIN = 10
VELOCITY_MAX = 30
DISTANCE_VEHICLE_ALIGNMENT = 80
DISTANCE_VEHICLE_COHESION = 50
DISTANCE_VEHICLE_SEPARATION = 20
VEHICLES = 7
...
function love.load()
  love.window.setTitle("Autonomous Agents - Combining behaviors - Separation, alignment and cohesion")
